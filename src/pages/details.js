...
export default function Details() {
  ...
  query {
    ...
    new: file(relativePath: { eq: "weddingDay/traditions/newShoes.jpg" }) {
      childImageSharp {
        fluid(maxWidth:800 maxHeight:800 fit:COVER) {
          ...GatsbyImageSharpFluid_withWebp
        }
    ...
    borrowed: file(relativePath: { eq: "weddingDay/traditions/borrowedJewelry.jpg" }) {
      childImageSharp {
        fluid(maxWidth:800 maxHeight:800 fit:COVER) {
          ...GatsbyImageSharpFluid_withWebp
        }
    ...
    blue: file(relativePath: { eq: "weddingDay/traditions/blueGarter.jpg" }) {
      childImageSharp {
        fluid(maxWidth:800 maxHeight:800 fit:COVER) {
          ...GatsbyImageSharpFluid_withWebp
        }
    ...
    sixpence: file(relativePath: { eq: "weddingDay/traditions/sixPence.jpg" }) {
      childImageSharp {
        fluid(maxWidth:800 maxHeight:400 fit:COVER) {
          ...GatsbyImageSharpFluid_withWebp
        }
        }
      }
    cakeTopper: file(relativePath: { eq: "weddingDay/traditions/cakeTopper.jpg" }) {
      childImageSharp {
        fluid(maxWidth:800 maxHeight:800 fit:COVER) {
          ...GatsbyImageSharpFluid_withWebp
        }
    ...
    pen: file(relativePath: { eq: "weddingDay/traditions/pen.jpg" }) {
      childImageSharp {
        fluid(maxWidth:800 maxHeight:800 fit:COVER) {
          ...GatsbyImageSharpFluid_withWebp
        }
